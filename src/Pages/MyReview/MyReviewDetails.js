...
const MyReviewDetails = ({ reviewdb }) => {
    const { name, review, photoURL } = reviewdb
    return (
        <div>
            <div className='border border-gray-300 bg-gray-800 rounded-lg shadow-md shadow-gray-500 p-5'>
                ...
                <div className='flex mt-10'>
                    <div className='mr-5'>
                        <button className='btn bg-orange-500'>Delete Review</button>
                    </div>
                    <div>
                        <button className='btn bg-orange-500'> Update Review</button>
                    </div>
                </div>
            </div>
        </div>
